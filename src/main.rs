...
use learn::{Buffer, BufferType, Shader, ShaderProgram, ShaderType, VertexArray};
use ogl33::*;
...
const FRAG_SHADER: &str = r#"#version 330 core
  ...
  void main() {
    final_color = texture(logo_texture, frag_tex);
  }
"#;

fn main() {

    let cube = Cube::new(CubeType::Dirt, true);
    ...
    let mut camera = EulerFPSCamera::at_position(Vec3 {
        x: 0.0,
        y: 0.0,
        z: -3.0,
    });
